...
enum ApiErrorCode {
  ...
  factory ApiErrorCode.fromApi(String? value) {
    return switch (value) {
      ...
      'PASSWORD_RESET_CODE_INVALID' => ApiErrorCode.passwordResetCodeInvalid,
      'PASSWORD_RESET_CODE_EXPIRED' => ApiErrorCode.passwordResetCodeExpired,
      'PASSWORD_RESET_RATE_LIMITED' => ApiErrorCode.passwordResetRateLimited,
      'PASSWORD_RESET_SESSION_INVALID' =>
        ApiErrorCode.passwordResetSessionInvalid,
